...
const CoreValues = () => {
  ...
  // Premium icons for each value
  const icons = [
    <HiOutlineCog key="excellence" className="w-8 h-8" />,
    <HiOutlinePuzzle key="transparency" className="w-8 h-8" />,
    <HiOutlineCurrencyDollar key="empowerment" className="w-8 h-8" />,
    <HiOutlineEmojiHappy key="innovation" className="w-8 h-8" />,
    <HiOutlineRefresh key="responsibility" className="w-8 h-8" />,
  ];
  ...
  return (
    <section className="relative py-20 md:py-24 lg:py-28 bg-[#27374e] overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
        ...
        {/* Values Grid - 5 Premium Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
          {/* First 3 cards */}
          {[0, 1, 2].map((index) => {
            const item = t(`values.items.${index}`);
